...
export class PlatformDetailComponent implements OnInit {
  ...
  getOrderDetail() {
    let me = this;
    let result = me.platformOrderService.getOrderDetailByNO(me.curOrdno);
  ...
  editPrimary(target) {
    ...
    this.platformOrderService.addRemark(data);
  ...
  public getOrderDetailInfo() {
    ...
    let orderStatesDetail = me.platformOrderService.getOrderState(ordno);
    ...
    if (me.hasDeliverData) me.expressData = me.platformOrderService.getExpressInfo(me.curOrdno);
  }
